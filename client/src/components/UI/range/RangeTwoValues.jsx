...
const RangeTwoValues = ({label, step, min, max, values, handleChange}) => {
  const [currentValues, setCurrentValues] = useState(values);
  const [minValueNumInput, setMinValueNumInput] = useState(parseFloat(values[0]).toString());
  const [maxValueNumInput, setMaxValueNumInput] = useState(parseFloat(values[1]).toString());
            ...
            <input 
                ...
                onBlur={e => {
                    ...
                    if (val <= currentValues[1] && val >= min){
                        ...
                        setMinValueNumInput(parseFloat(min).toString());
